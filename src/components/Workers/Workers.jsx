    ...
    <div>
      <Container>
        ...
        <div className="Sotrudniki-section">
          ...
          <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.atametovData')} >
          ...
          <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.xurramiddinData')}>
            ...
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.qodirovData')}>
              <div className="WorkerCard" onClick={() =>setPhoto(qodirov)}>
                <div className="WorkerImage">
                  <img src={qodirov} alt="" />
                </div>
                <div className="WorkerTexts">
                  <h4 className="titleName">{t("Employers.qodirovData.name")}</h4>
                  <div className="jobDesc">{t("Employers.qodirovData.job")}</div>
                </div>
              </div>
            </Col>
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.sobirovData')}>
              <div className="WorkerCard" onClick={() =>setPhoto(sobirov)}>
                <div className="WorkerImage">
                  <img src={sobirov} alt="" />
                </div>
                <div className="WorkerTexts">
                  <h4 className="titleName">{t("Employers.sobirovData.name")}</h4>
                  <div className="jobDesc">{t("Employers.sobirovData.job")}</div>
                </div>
              </div>
            </Col>
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.razbekovData')}>
              <div className="WorkerCard" onClick={() =>setPhoto(razbekov)}>
                <div className="WorkerImage">
                  <img src={razbekov} alt="" />
                </div>
                <div className="WorkerTexts">
                  <h4 className="titleName">{t("Employers.razbekovData.name")}</h4>
                  <div className="jobDesc">{t("Employers.razbekovData.job")}</div>
                </div>
              </div>
            </Col>
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.latipovData')}>
              <div className="WorkerCard" onClick={() =>setPhoto(latipov)}>
                <div className="WorkerImage">
                  <img src={latipov} alt="" />
                </div>
                <div className="WorkerTexts">
                  <h4 className="titleName">{t("Employers.latipovData.name")}</h4>
                  <div className="jobDesc">{t("Employers.latipovData.job")}</div>
                </div>
              </div>
            </Col>
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.akkulovData')}>
              <div className="WorkerCard" onClick={() =>setPhoto(akkulov)}>
                <div className="WorkerImage">
                  <img src={akkulov} alt="" />
                </div>
                <div className="WorkerTexts">
                  <h4 className="titleName">{t("Employers.akkulovData.name")}</h4>
                  <div className="jobDesc">{t("Employers.akkulovData.job")}</div>
                </div>
              </div>
            </Col>
            <Col className="centerCol" lg="4" md="6" sm="12" onClick={() => setworker('Employers.tanikulovData')}>
